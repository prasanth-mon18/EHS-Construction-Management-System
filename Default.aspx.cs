        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (countIC2 == 0)
                {
                    ...
                    "'" + datetimeNow + "','" + space + "',(select COMP_NAME from VENDOR_ATT_MST where IC_NO = '" + ScanHere.Text + "'),(select EMP_NAME from VENDOR_ATT_MST where IC_NO = '" + ScanHere.Text + "'),'PJ5C')", conn);
                    conn.Open();
