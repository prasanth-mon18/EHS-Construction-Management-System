<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default1.aspx.cs" Inherits="EHS_Construction_Management_System.Default1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>MF2 Vendor TBM Daily Attendance</title>
    ...
    <form id="form1" runat="server" style="overflow: auto">
        <div>
            ...
            <asp:Panel ID="Panel3" runat="server" CssClass="floatRight" HorizontalAlign="Center" Width="29%" Font-Bold="True" ForeColor="Black" Wrap="False">
                ...
                <asp:TextBox ID="TextBox1" runat="server" Style="text-align: center" Font-Bold="True" Font-Names="Arial Black" Font-Size="XX-Large" ForeColor="Black" Height="45px" Width="100px" BorderStyle="None" AutoPostBack="True" ReadOnly="True">MF2</asp:TextBox>
                <br />
                <br />
            ...
            <br />
                <br />
<%--            <asp:Panel ID="Panel5" runat="server" HorizontalAlign="center" Width="29%">
                <asp:GridView ID="GridView2" runat="server" CssClass="Grid" HorizontalAlign="Center" AutoGenerateColumns="False" CellPadding="4" Font-Bold="True" Font-Names="Arial" Font-Size="X-Large">
                    <Columns>
                        <asp:TemplateField>
                            <HeaderTemplate>
                                No.
