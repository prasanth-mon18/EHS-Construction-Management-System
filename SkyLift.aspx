<%@ Page Title="High Risk Machinery & Equipment List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SkyLift.aspx.cs" Inherits="EHS_Construction_Management_System.SkyLift" EnableEventValidation="false" %>

<asp:Content ID="SkyLift" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        .sub-bar {
            background: #F4F6F9;
            padding: 15px;
...
<asp:Content ID="SkyLiftMain" ContentPlaceHolderID="MainContent" runat="server">

        <!-- MAIN GRID -->
    <asp:Panel ID="pnlMachineryForm" runat="server">
        <%--<h2>High Risk Machinery & Equipment List</h2>--%>
        <div style="overflow-x: auto; width: 100%;">
            <asp:GridView ID="GridSkylift" runat="server" AutoGenerateColumns="False" CellPadding="4" 
                GridLines="Both" Width="100%" OnRowCreated="GridSkylift_RowCreated" OnRowDataBound="GridSkylift_RowDataBound" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" ForeColor="Black">
                ...
                <Columns>
                    ...
                    <%-- 6. Driving License (OK/NG) --%>
                    <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <asp:TextBox ID="txtLicense" runat="server" Width="85px" Text='<%# Bind("DRIVING_LICENSE") %>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <%-- 9. Date with Calendar Extension Popup --%>
        ...
        <asp:Button ID="btnSaveSkyLift" runat="server" Text="Save Machinery Records" OnClick="btnSaveSkyLift_Click" Font-Bold="True" Height="40px" Width="220px" BackColor="#27AE60" ForeColor="White" BorderStyle="None" Style="cursor: pointer; border-radius: 4px;" />
            ...
            <div style="overflow-x: auto; width: 100%; clear: both;">
                <asp:GridView ID="GridHistory" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="Both" Width="100%" BackColor="White" BorderColor="#989898" BorderStyle="None" BorderWidth="1px" ForeColor="Black"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DRIVING_LICENSE" HeaderText="License H" />
